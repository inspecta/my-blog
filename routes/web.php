...
// Delete a post
Route::delete('/delete/{post}', [PostController::class, "deletePost"])->middleware('can:delete,post');

// Update a post
Route::get('/edit-post/{post}', [PostController::class, "showEditPostForm"])->middleware('can:update,post');
